...
class RockPaperScissors:
    def __init__(self,filepath=None,training_data = None,importcsv=None) -> None:
        ...
        random.shuffle(self.player_actions_num)
    ...
    def run_game(self,verbose_all=0,should_update = False):
        ...
        for iterations,action in enumerate(self.player_actions_num):    
            ...
            # CPU's turn
                ...
                new_cut = pd.DataFrame([[action,new_q_result]],columns=["action","cpu"])
            ...
            if should_update == True:
                ...
                new_q_result = new_q.loc[new_q.index == iterations,["cpu"]].iloc[0,0]
        ...
        q_table.to_csv(r"C:\Users\user1\Desktop\Bae Rock_paper_scissors\data\q_learning_rock.csv")
...
if __name__ == "__main__":
    ...
    rockpaperscissors.run_game(verbose_all=1,should_update=True)
    #pass
    #should_update = False